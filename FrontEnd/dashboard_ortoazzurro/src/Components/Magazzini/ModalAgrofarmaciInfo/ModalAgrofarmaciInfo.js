import './ModalAgrofarmaciInfo.css';
...
const ModalAgrofarmaciInfo = ({data, onClose}) => {
            ...
            <div className="modal-dialog">
                ...
                <div className="modal-content">
                    <div className="modal-header">
                        <img src={agrofarmacoImage} width={45} alt='...' className='pe-2 invert'/>
                        <h5 className="modal-title">Saldi Agrofarmaci</h5>
...
export default ModalAgrofarmaciInfo;