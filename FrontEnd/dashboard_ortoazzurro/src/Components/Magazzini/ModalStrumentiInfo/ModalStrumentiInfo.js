...
const ModalStrumentiInfo = ({data, onClose}) => {
            ...
            <div className="modal-dialog">
                ...
                <div className="modal-content">
                    <div className="modal-header">
                        <img src={strumentoImage} width={45} alt='...' className='pe-2 invert'/>
                        <h5 className="modal-title">Saldi Strumenti</h5>
...
export default ModalStrumentiInfo;