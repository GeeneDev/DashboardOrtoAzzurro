import './ModalFertilizzantiInfo.css';
...
const ModalFertilizzantiInfo = ({data, onClose}) => {
            ...
            <div className="modal-dialog">
                ...
                <div className="modal-content">
                    <div className="modal-header">
                        <img src={fertilizzanteImage} width={45} alt='...' className='pe-2 invert'/>
                        <h5 className="modal-title">Saldi Fertilizzanti</h5>
...
export default ModalFertilizzantiInfo;