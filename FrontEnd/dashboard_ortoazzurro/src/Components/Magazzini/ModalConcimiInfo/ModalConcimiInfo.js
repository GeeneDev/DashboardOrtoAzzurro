...
const ModalConcimiInfo = ({data, onClose}) => {
            ...
            <div className="modal-dialog">
                ...
                <div className="modal-content">
                    <div className="modal-header">
                        <img src={concimeImage} width={45} alt='...' className='pe-2 invert'/>
                        <h5 className="modal-title">Saldi Concimi</h5>
...
export default ModalConcimiInfo;